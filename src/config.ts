...
Полное переосмысление стиля с нуля. Разобрали цветотип, тип фигуры, образ жизни и собрали капсулу из 30+ готовых луков. Клиентка прошла путь от «не знаю, что надеть» до «мой гардероб — моя суперсила». От 45 000 ₽.",
    },
    {
...
Деловой образ для женщины-лидера. Ставка на архитектурный крой, премиальные ткани и силуэт, который говорит громче слов. Никакой суеты — только статус, авторитет и безупречный вкус. От 35 000 ₽.",
    },
    {
...
Воздушный образ для свиданий, путешествий и творческих съёмок. Льняные фактуры, ручная вышивка, винтажные аксессуары — всё дышит свободой и нежностью. От 25 000 ₽.",
    },
    {
...
Мужской гардероб нового поколения: от классики до smart casual. Продумали каждую деталь — посадку, сочетаемость, сезонность. Результат: 100% попаданий, 0 лишних вещей. От 40 000 ₽.",
    },
    {
...
Вечерний выход, где каждая деталь работает на вау-эффект. Ткань, аксессуары, макияж и укладка собраны в единую историю. Вы будете сиять — гарантированно. От 15 000 ₽.",
    },
    {
...
Городской лук с характером. Миксуем премиум и масс-маркет, тренды и базу, дерзость и интеллигентность. Для тех, кто носит одежду, а не наоборот. От 30 000 ₽.",
    },
    {
...
Парный выход, где вы дополняете друг друга, но не копируете. Цветовые рифмы, стилистический диалог, общая ДНК без потери индивидуальности. От 50 000 ₽.",
    },
    {
...
Минимализм, который кричит о вкусе шёпотом. Идеальная база из топовых материалов, безупречный крой, никаких логотипов — только чистая элегантность. От 35 000 ₽.",
    },
    {
...
Максимальный блеск для красной дорожки и не только. Платье, которое притягивает взгляды, ювелирные акценты и голливудский вайб. Для вечера, который запомнят все. От 25 000 ₽.",
    },
  ],
